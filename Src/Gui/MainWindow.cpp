...
//    this->splitDockWidget(dockWidget2,dockWidget6,Qt::Horizontal);
//    this->splitDockWidget(dockWidget1,dockWidget4,Qt::Vertical);
//    this->splitDockWidget(dockWidget2,dockWidget5,Qt::Vertical);
//    this->splitDockWidget(dockWidget6,dockWidget7,Qt::Vertical);
